...
namespace PatternObserverViaEventHandler
{
    ...
    public sealed class Thermostat
    {
        ...
        /// <summary>
        /// Adds the temperature changed.
        /// </summary>
        /// <param name="handler">The handler.</param>
        public void Add_TemperatureChanged(EventHandler<TemperatureChangedEventArgs> handler)
        {
            temperatureChanged = (EventHandler<TemperatureChangedEventArgs>)Delegate.Combine(temperatureChanged, handler);
        }

        /// <summary>
        /// Removes the temperature changed.
        /// </summary>
        /// <param name="handler">The handler.</param>
        public void Remove_TemperatureChanged(EventHandler<TemperatureChangedEventArgs> handler)
        {
            temperatureChanged = (EventHandler<TemperatureChangedEventArgs>)Delegate.Remove(temperatureChanged, handler);
        }
